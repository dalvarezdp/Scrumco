#encoding:utf-8
"""
Django settings for scrumco project.
...
SECRET_KEY = '^$s-y@a)l+yw@@vgbct9wyioudxe(r9#bmch#^bmwf)^@-=0g6'
...
ROOT_URLCONF = 'scrumco.urls'

WSGI_APPLICATION = 'scrumco.wsgi.application'
